...
export const DEFAULT_SERVICES: ServiceCardItem[] = [
  {
    ...
    detailSections: [
      ...
      "Eigentumswohnung: 599,00 €",
      "Einfamilienhaus: 699,00 €",
      "Zweifamilienhaus: 799,00 €",
      "Mehrfamilienhaus: 899,00 €",
      "Preisgestaltung",
      "Bei einer bestehenden Verkaufsabsicht ist die Wertermittlung Ihrer Immobilie für Sie kostenfrei. Wird die Bewertung ausschließlich als unverbindliche Markt- bzw. Preiseinschätzung ohne Verkaufsabsicht gewünscht, stellen wir eine angemessene Honorargebühr in Rechnung.",
      "Sollte die Bewertung ausschließlich als unverbindliche Markt- bzw. Preiseinschätzung ohne Verkaufsabsicht gewünscht sein, unterscheiden wir in unserer Preisgestaltung nach Objektart und Entfernung. Die Leistungsinhalte sind dabei stets gleich.",
    ...
    detailSectionsEn: [
      ...
      "Condominium / Apartment: €599.00",
      "Single-family house: €699.00",
      "Two-family house: €799.00",
      "Multi-family house: €899.00",
      "Property Valuation – Pricing",
      "If you already intend to sell, the valuation of your property is free of charge for you. If you require a valuation solely as a non-binding market or price estimate without any intention to sell, we will charge an appropriate fee.",
      "If the valuation is required solely as a non-binding market or price estimate without any intention to sell, our pricing varies depending on the type of property and the distance. The scope of services remains identical in all cases.",
    ...
    detailSectionsTr: [
      ...
      "Satılık daire: 599,00 €",
      "Müstakil ev: 699,00 €",
      "İki ailelik ev: 799,00 €",
      "Çok aileli bina: 899,00 €",
      "Fiyatlandırma",
      "Mevcut bir satış niyetiniz varsa gayrimenkulünüzün değerlemesi sizin için ücretsizdir. Değerleme yalnızca satış niyeti olmadan bağlayıcı olmayan bir piyasa veya fiyat tahmini olarak istenirse, makul bir ücret yansıtılır.",
      "Değerleme yalnızca satış niyeti olmadan bağlayıcı olmayan bir piyasa veya fiyat tahmini olarak isteniyorsa fiyatlandırmada obje türü ve mesafeye göre ayrım yapıyoruz. Hizmet kapsamı her durumda aynıdır.",
