...
export function staticPropertyToProperty(
  ...
  return {
    ...
    anzahl_schlafzimmer: p.anzahlSchlafzimmer ?? null,
    anzahl_badezimmer: p.anzahlBad ?? null,
    anzahl_sep_wc: p.anzahlGaesteWc ?? null,
    anzahl_balkone: p.anzahlBalkone ?? null,
    anzahl_terrassen: p.anzahlTerrasse ?? null,
    etage: p.etage ?? null,
