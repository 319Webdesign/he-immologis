...
export default async function ImmobilienPage({ searchParams }: PageProps) {
    ...
    <>
      ...
      <section className="bg-zinc-100 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl text-center">
          <h1 className="font-display text-4xl font-semibold tracking-tight text-zinc-900 sm:text-5xl">
