          ...
          <div className="mt-10 space-y-8 text-slate-700">
            <section>
              ...
              <div className="mt-2 grid grid-cols-[auto_1fr] items-baseline gap-x-2 gap-y-0.5">
                <span>Phone:</span>
                <a href="tel:+491776361394" className="text-[#F9423A] underline hover:no-underline">
                  +49 177 636 1394
                </a>
                <span>Email:</span>
                <a href="mailto:info@he-immologis.de" className="text-[#F9423A] underline hover:no-underline">
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                <Link href={`${prefix}/cookies`} className="text-[#F9423A] underline hover:no-underline">
                  Cookie Policy
                </Link>
                .
              </p>
          ...
          <div className="mt-10 space-y-8 text-slate-700">
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                <Link href={`${prefix}/cookies`} className="text-[#F9423A] underline hover:no-underline">Çerez Politikamıza</Link> bakınız.
              </p>
            </section>
            <section>
