          ...
          <div className="mt-10 space-y-8 text-slate-700">
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-[#F9423A] underline hover:no-underline">https://ec.europa.eu/consumers/odr</a>.
