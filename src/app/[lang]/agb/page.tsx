      ...
      <article className="bg-white">
        <div className={LEGAL_CONTENT}>
          <p className="text-sm text-slate-600">
            HE immologis UG · Ahornstr. 59 · 69469 Weinheim
          </p>
          ...
          <div className="mt-10 space-y-8 text-slate-700">
            ...
            <section>
              ...
              <p className="mt-2">
                All information and documents provided by HE immologis UG, including property details, are intended solely for our client and may only be passed on to third parties with the written consent of HE immologis UG Breaches of this obligation may render the person passing on the information liable for damages in the event that a main contract (lease or purchase agreement) is concluded. If a contract is consequently concluded with the third party, the client shall owe HE immologis UG the agreed commission. The client reserves the right to prove that HE immologis UG has suffered no loss or a lesser loss.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                The client expressly agrees that HE immologis UG is authorised to process the client’s personal data as necessary for the performance of its obligations in accordance with the applicable legal provisions.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                HE immologis UG points out that the property information, documents, plans etc. passed on by HE immologis UG originate from the seller or landlord. HE immologis UG therefore does not assume any liability or warranty for the accuracy or completeness of such information. It is the responsibility of the client of HE immologis UG to verify the accuracy of the property information and details contained therein. HE immologis UG shall only be liable in cases of intent, gross negligence, absence of guaranteed characteristics or culpable breach of a fundamental contractual obligation. Otherwise, the statutory limitation periods apply. If the client is a merchant, claims for damages shall become time-barred after three years from their accrual, at the latest three years after termination of the mandate. Otherwise, the statutory provisions apply.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                HE immologis UG is entitled to engage one or more additional brokers to fulfil the mandate.
              </p>
            </section>
            ...
            <section id="widerruf">
              ...
              <p className="mt-2">
                If the client withdraws from this contract, HE immologis UG shall reimburse all payments received from the client without undue delay and at the latest within fourteen days of the day on which the notification of withdrawal from this contract was received.
              </p>
              <p className="mt-2">
                If the client has expressly requested that the brokerage services commence during the withdrawal period, the client shall pay HE immologis UG a reasonable amount corresponding to the proportion of services already provided by the time of withdrawal in relation to the total scope of the services contractually agreed.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p className="mt-2">
                Contact with the property owner must always be initiated through HE immologis UG
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Property details and exposés are based on information provided by the owner or client. Only the respective provider of the information is liable for information supplied by the owner or client, including towards third parties. HE immologis UG therefore does not assume any liability or warranty for the accuracy and completeness of the details.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                A reservation and effort fee of 10% of the agreed brokerage commission is charged for reservations. If the notarial purchase agreement is concluded, the advance payment is offset. If the purchase agreement is not concluded, the fee remains with HE immologis UG as remuneration for the services provided. Commission becomes due upon conclusion of the purchase, lease or tenancy agreement. Commission is calculated on the basis of the proven or brokered contract. If no contract is submitted, calculation is based on the offer data.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p className="mt-2">
                HE immologis UG is entitled to attend the notarial execution of the contract.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Unless otherwise agreed in writing, HE immologis UG provides proof or brokerage services. Proof activity is limited to the naming and description of a specific property.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                HE immologis UG also has a claim to commission in respect of follow-on transactions concluded within a temporal and economic context from the original contract. A follow-on transaction exists when an extension or modification of the concluded contract opportunity occurs.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                If the client is already aware of the property proved to them, they must notify HE immologis UG thereof in writing without undue delay, at the latest within 5 working days, and provide evidence. If the client fails to give such notification, the property shall be deemed unknown.
              </p>
              <p className="mt-2">
                The client is obliged to inform HE immologis UG whether, when and with whom a contract was concluded and what purchase price or rent or lease was agreed. The contract must be submitted immediately after conclusion. HE immologis UG is entitled to obtain information from land registries, notaries and other parties involved for this purpose.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                For properties that have been entrusted to HE immologis UG for marketing, the owner is obliged to enquire in writing with HE immologis UG before concluding an intended main contract (in particular purchase or lease agreement), stating the name and full address of the intended contracting party, whether the introduction of this contracting party is attributable to the activity of HE immologis UG The main contract may only be concluded after corresponding information or confirmation has been provided by HE immologis UG
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Side agreements require written confirmation by HE immologis UG to be effective.
              </p>
            </section>
      ...
      <div className={LEGAL_CONTENT}>
        ...
        <div className="mt-10 space-y-8 text-slate-700">
          ...
          <section>
            ...
            <p className="mt-2">
              Alle durch die HE immologis UG erteilten Informationen und Unterlagen inklusive der Objektnachweise sind ausschließlich für unseren Auftraggeber bestimmt und dürfen nur mit schriftlicher Einwilligung von HE immologis UG an Dritte weitergegeben werden. Schuldhafte Zuwiderhandlungen können den Weitergebenden gegebenenfalls im Falle des Zustandekommens eines Hauptvertrages (Miet- oder Kaufvertrages) zu Schadensersatzzahlungen verpflichten. Kommt infolgedessen ein Vertrag mit dem Dritten zustande, schuldet der Auftraggeber der HE immologis UG die vereinbarte Provision. Dem Auftraggeber bleibt der Nachweis vorbehalten, dass der HE immologis UG kein oder ein geringerer Schaden entstanden ist.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Der Auftraggeber erklärt sich ausdrücklich damit einverstanden, dass die HE immologis UG zur Erfüllung Ihrer Verpflichtungen befugt ist, die notwendigen personenbezogenen Daten des Auftraggebers nach Maßgabe der gesetzlichen Regelungen zu verarbeiten.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Die HE immologis UG weist darauf hin, dass die von der HE immologis UG weitergegebenen Objektinformationen, Unterlagen, Pläne etc. vom Veräußerer bzw. Vermieter stammen. Eine Haftung beziehungsweise Gewähr für die Richtigkeit oder Vollständigkeit der Angaben übernimmt die HE immologis UG daher nicht. Es obliegt daher an den Kunden der HE immologis UG, die darin enthaltenen Objektinformationen und Angaben auf ihre Richtigkeit hin zu überprüfen. Die HE immologis UG haftet nur bei Vorsatz, grober Fahrlässigkeit, dem Fehlen garantierter Eigenschaften oder bei schuldhafter Verletzung einer Kardinalspflicht. Im Übrigen gelten die gesetzlichen Verjährungsvorschriften. Ist der Auftraggeber Kaufmann, verjähren Schadensersatzansprüche in drei Jahren ab Entstehung, spätestens drei Jahre nach Beendigung des Auftrags. Ansonsten gilt die Regelung nach den gesetzlichen Bestimmungen.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Die HE immologis UG ist berechtigt, einen oder weitere Makler zur Erfüllung des Auftrags hinzuzuziehen.
            </p>
          </section>
          ...
          <section id="widerruf">
            ...
            <p className="mt-2">
              Widerruft der Auftraggeber diesen Vertrag, hat die HE immologis UG alle Zahlungen, die sie vom Auftraggeber erhalten hat, unverzüglich und spätestens binnen vierzehn Tagen ab dem Tag zurückzuzahlen, an dem die Mitteilung über den Widerruf dieses Vertrags eingegangen ist.
            </p>
            <p className="mt-2">
              Hat der Auftraggeber ausdrücklich verlangt, dass die Maklertätigkeit während der Widerrufsfrist beginnen soll, so hat der Auftraggeber der HE immologis UG einen angemessenen Betrag zu zahlen, der dem Anteil der bis zum Zeitpunkt des Widerrufs bereits erbrachten Leistungen im Vergleich zum Gesamtumfang der vertraglich vorgesehenen Leistungen entspricht.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mt-2">
              Die Kontaktaufnahme mit dem Anbieter ist stets über die HE immologis UG einzuleiten.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Objektangaben sowie Exposés beruhen auf den vom Anbieter bzw. Auftraggeber erteilten Informationen. Für die vom Anbieter oder Auftraggeber gelieferten Informationen haftet ausschließlich der jeweilige Informationsgeber auch gegenüber Dritten. Eine Haftung bzw. Gewähr für die Richtigkeit und Vollständigkeit der Angaben wird daher von der HE immologis UG nicht übernommen.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Handelt es sich bei dem Hauptvertrag zudem um einen Mietvertrag, ist eine Provision von Seiten des Wohnungssuchenden nur dann zu leisten, wenn HE immologis UG ausschließlich wegen des Auftrages des Wohnungssuchenden das Wohnungsangebot eingeholt und eine Provisionspflicht zuvor vereinbart wurde. Ist der Auftrag jedoch vom Vermieter ausgegangen bzw. von diesem ebenfalls gestellt, so kann die HE immologis UG nur von diesem eine Provision einfordern, sofern entsprechend vorher vereinbart. Sie ist innerhalb von zehn Tagen nach Rechnungsstellung zahlbar. Sollte unsere Nachweis- oder Vermittlungstätigkeit der gewünschte Hauptvertrag zustande kommen, sowohl die Höhe der Provision, als auch die jeweilige Zahlung des Auftraggebers richtet sich nach dem Standort der Immobilie und der dort ortsüblichen Provision bzw. den Vorgaben des § 3 Absatz 2 des Gesetzes zur Regelung der Wohnungsvermittlung (Begrenzung auf zwei Monatsmieten zuzüglich der gesetzlichen Umsatzsteuer), soweit in dem jeweiligen Angebot nicht ausdrücklich ein anderer Provisionssatz genannt ist.
            </p>
            <ul className="mt-2 list-inside list-disc space-y-1">
            ...
            <p className="mt-2">
              Für Reservierungen wird ein Reservierungs- und Bemühungsentgelt in Höhe von 10 % der vereinbarten Maklerprovision erhoben. Kommt der notarielle Kaufvertrag zustande, wird der Vorschuss verrechnet. Sofern der Kaufvertrag nicht zustande kommt, verbleibt das Entgelt als Vergütung für die Tätigkeit bei der HE immologis UG Die Provision wird mit Abschluss des Kauf-, Miet- oder Pachtvertrages fällig. Die Provisionsabrechnung erfolgt auf Grundlage des nachgewiesenen oder vermittelten Vertrages. Wird kein Vertrag vorgelegt, erfolgt die Berechnung nach den Angebotsdaten.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mt-2">
              Die HE immologis UG ist berechtigt, am notariellen Vertragsabschluss teilzunehmen.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Soweit keine abweichende schriftliche Vereinbarung getroffen wurde, erbringt die HE immologis UG eine Nachweis- oder Vermittlungstätigkeit. Die Nachweistätigkeit beschränkt sich auf die Benennung und Beschreibung eines konkreten Objektes.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Ein Provisionsanspruch der HE immologis UG besteht auch bei Folgegeschäften, die innerhalb eines zeitlichen und wirtschaftlichen Zusammenhangs seit dem Ursprungsvertrag abgeschlossen werden. Ein Folgegeschäfts liegt dabei vor, wenn eine Erweiterung oder Veränderung der abgeschlossenen Vertragsgelegenheit eintritt.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Der Auftraggeber ist verpflichtet mitzuteilen, ob, wann und mit wem ein Vertrag zustande kam sowie welcher Kaufpreis bzw. Miet- oder Pachtzins vereinbart wurde. Der Vertrag ist unmittelbar nach Abschluss vorzulegen. Die HE immologis UG ist berechtigt, hierzu Auskünfte bei Grundbuchämtern, Notaren und sonstigen Beteiligten einzuholen.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Für Objekte, die der HE immologis UG zur Vermarktung überlassen wurden, ist der Eigentümer verpflichtet, vor Abschluss eines beabsichtigten Hauptvertrages (insbesondere Kauf- oder Mietvertrag) unter Angabe von Namen und vollständiger Anschrift des vorgesehenen Vertragspartners bei der HE immologis UG schriftlich anzufragen, ob die Zuführung dieses Vertragspartners auf eine Tätigkeit der HE immologis UG zurückzuführen ist. Der Hauptvertrag darf erst nach entsprechender Auskunft bzw. Bestätigung durch die HE immologis UG abgeschlossen werden.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Nebenabreden bedürfen zu ihrer Wirksamkeit der schriftlichen Bestätigung durch die HE immologis UG
            </p>
          </section>
