        ...
        <div className={LEGAL_CONTENT}>
          ...
          <div className="mt-10 space-y-8 text-slate-700">
            ...
            <section id="widerruf">
              ...
              <p className="mt-2">
                To exercise the right of withdrawal, the client must inform HE immologis UG (haftungsbeschränkt) i. Gr., Ahornstr. 59, 69469 Weinheim, email info@he-immologis.de, mobile +49 1776361394, of the decision to withdraw from this contract by means of a clear statement (e.g. by letter or email). The client may use the model withdrawal form provided for this purpose, although its use is not mandatory.
              </p>
              <p className="mt-2">
        ...
        <div className={LEGAL_CONTENT}>
          ...
          <div className="mt-10 space-y-8 text-slate-700">
            ...
            <section id="widerruf">
              ...
              <p className="mt-2">
                Cayma süresi sözleşme tarihinden itibaren 14 gündür. Cayma için bize (HE immologis UG, Ahornstr. 59, 69469 Weinheim, info@he-immologis.de, +49 1776361394) net bir bildirim (mektup veya e-posta) yeterlidir.
              </p>
              <p className="mt-2">
      ...
      <div className={LEGAL_CONTENT}>
        ...
        <div className="mt-10 space-y-8 text-slate-700">
          ...
          <section id="widerruf">
            ...
            <p className="mt-2">
              Um das Widerrufsrecht auszuüben, muss der Auftraggeber der HE immologis UG (haftungsbeschränkt) i. Gr., Ahornstr. 59, 69469 Weinheim, E-Mail info@he-immologis.de, Mobil +49 1776361394, mittels einer eindeutigen Erklärung (z. B. per Brief oder E-Mail) über seinen Entschluss, diesen Vertrag zu widerrufen, informieren. Der Auftraggeber kann dafür das beigefügte Muster-Widerrufsformular verwenden, das jedoch nicht vorgeschrieben ist.
            </p>
            <p className="mt-2">
