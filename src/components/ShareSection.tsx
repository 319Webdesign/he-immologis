      ...
      <div className="mx-auto max-w-2xl rounded-2xl border border-slate-200/80 bg-white px-6 py-8 shadow-sm sm:px-8 sm:py-10">
        ...
        <div className="mt-6 flex justify-center">
          <button
            type="button"
            onClick={handleClick}
            className="inline-flex items-center gap-2 rounded-xl px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#85b09a] focus:ring-offset-2 active:opacity-95 sm:px-8 sm:py-4 sm:text-base"
