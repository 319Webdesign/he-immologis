...
interface MainServiceCardProps {
  dict: MainServiceCardDict;
  lang: string;
}

export default function MainServiceCard({ dict, lang }: MainServiceCardProps) {
  const detailHref = lang ? `/${lang}/immobilien-services/immobilienverkauf` : "/immobilien-services/immobilienverkauf";
    ...
    >
      <div className="grid min-h-[320px] grid-cols-1 lg:grid-cols-2">
        <div className="relative aspect-[16/10] lg:aspect-auto lg:min-h-[320px]">
          <Image
            src={IMAGE_SRC}
            alt="Einfamilienhaus zum Kauf in Weinheim - HE-immologis"
            fill
        ...
        <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10">
          ...
          <ul className="mt-6 space-y-3" aria-label={dict.stepsIntro}>
