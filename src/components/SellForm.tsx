...
export default function SellForm({
  ...
  const inputBase =
    "mt-2 block w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition-colors placeholder:text-slate-400 focus:border-[#F9423A] focus:ring-1 focus:ring-[#F9423A]/30";
  ...
  if (isSubmitted) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center shadow-sm sm:p-16">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#F9423A]/10">
          <svg
            className="h-8 w-8 text-[#F9423A]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-start">
            <div className="flex items-start gap-3">
              <input
                ...
                onChange={handleChange}
                className="mt-1 h-4 w-4 shrink-0 rounded border-slate-300 text-[#F9423A] focus:ring-[#F9423A]/30"
              ...
              <label htmlFor="agbAkzeptiert" className="text-sm text-slate-700">
                ...
                <Link
                  ...
                  className="text-[#F9423A] underline hover:opacity-80"
                >
                  {dict.agbLinkText}
                </Link>
                {dict.agbLabelSuffix}
        ...
        <div className="pt-2">
          <button
            type="submit"
            disabled={isSending}
            className="w-full rounded-lg px-6 py-4 text-base font-semibold text-white transition-colors hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#F9423A]/40 focus:ring-offset-2 disabled:opacity-70 sm:w-auto sm:min-w-[200px]"
